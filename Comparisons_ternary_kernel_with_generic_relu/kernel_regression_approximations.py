...
testcase = 'cifar10'  ### 'mnist' , 'cifar10' , 'fashion', 'imdb' , 'boston'
...
def main():
    for D in sample_sizes:
        ...
        feature_map_nystroem = Nystroem(n_components=D, gamma=.031, random_state=1)
