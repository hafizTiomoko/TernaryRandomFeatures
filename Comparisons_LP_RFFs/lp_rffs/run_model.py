...
#currentdir2 = parentdir1
#parentdir2 = os.path.dirname(currentdir2)
...
if __name__ == "__main__":
    ...
    # load dataset
    X_train, X_val, Y_train, Y_val, s_minus, s_plus = load_data(args.data_path)
    ...
    if args.approx_type == "exact":
        ...
        kernel_approx = TernaryRFF(n_quantized_rff, n_input_feat, s_minus=s_minus, s_plus= s_plus, kernel=kernel)
        #kernel_approx.setup(X_train)
        quantizer = None
